...
#Add your code here!
print("Happy: " + str(not stressed and busy))
print("Sad: " + str(hungry or tired))
print("Confused: " + str((not stressed and busy) and (hungry or tired)))
print("Bored: " + str(not(not stressed and busy) and not(hungry or tired) and not busy))
print("Anxious: " + str(not(not stressed and busy) and not(hungry or tired) and stressed))