...
hours1=length//60
minutes1=length%60
middle_hour=start_hour+hours1
middle_minutes=start_minute+minutes1
hours2=middle_minutes//60
minutes2=middle_minutes%60
final_hour=middle_hour+hours2
final_minutes=minutes2
print(str(final_hour)+":"+str(final_minutes))