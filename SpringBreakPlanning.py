...
if can_afford:
    if destination_is_safe:
        acceptable_location1 = True
else:
        acceptable_location1 = False
if not can_afford:
    if destination_is_safe and educational_value or relatives_nearby:
        acceptable_location2 = True
    else:
        acceptable_location2 = False
else:
        acceptable_location2 = False

if is_international and have_passport and not afraid_to_fly:
    acceptable_location3 = True
elif not is_international and (have_a_car or not afraid_to_fly):
    acceptable_location3 = True
else:
    acceptable_location3 = False

if is_a_beach and is_warm:
    acceptable_location4 = True
elif has_skiing and not is_warm:
    acceptable_location4 = True
elif is_a_city and is_off_peak or has_attraction:
    acceptable_location4 = True
elif is_a_beach and is_a_city:
    if is_warm or has_attraction or is_off_peak:
        acceptable_location4 = True
    else:
        acceptable_location4 = False
elif has_skiing and is_a_city:
    if not is_warm or has_attraction or is_off_peak:
        acceptable_location4 = True
    else:
        acceptable_location4 = False
else:
...
acceptable_location = (acceptable_location1 or acceptable_location2) and acceptable_location3 and acceptable_location4

#print(acceptable_location1)  #for testing purposes
#print(acceptable_location2)
#print(acceptable_location3)
#print(acceptable_location4)
